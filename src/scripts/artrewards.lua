...
function give_winner1()
  ...
  s = "Glückwunsch zum Gewinn des Wettstreit der Künste, " .. winner1.name .. "."
...
function give_winner2()
  ...
  s = "Glückwunsch zum zweiten Platz im Wettstreit der Künste, " .. winner2.name .. "."
...
function give_winner3()
  ...
  s = "Glückwunsch zum dritten Platz im Wettstreit der Künste, " .. winner3.name .. "."
...
function give_loser()
  ...
  s = "Glückwunsch zum Gewinn des Nachwuchspreises im Wettstreit der Künste, " .. loser.name .. "."
...
function give_visitor1()
  ...
  s = "Glückwunsch zum Gewinn eines Besucherpreises im Wettstreit der Künste, " .. visitor1.name .. "."
...
function give_visitor2()
  ...
  s = "Glückwunsch zum Gewinn eines Besucherpreises im Wettstreit der Künste, " .. visitor2.name .. "."
