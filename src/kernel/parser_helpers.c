...
/**
 * returns NULL if there is no id parameter or there is an id parameter but no building with this
 * id
 */
...
/**
 * returns NULL if there is no id parameter or there is an id parameter but no ship with this
 * id
 */
